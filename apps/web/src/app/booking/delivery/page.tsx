    ...
    <div className="min-h-screen bg-surface font-jakarta">
      ...
      <div className="max-w-lg mx-auto px-5 py-10">
        <div className="text-center mb-8">
          ...
          <h1 className="font-grotesk text-[26px] font-semibold text-ink mb-2">You&apos;re booked!</h1>
        ...
        <div className="space-y-3 mb-8">
          ...
          >
            <div className="w-11 h-11 rounded-[12px] bg-teal-tint flex items-center justify-center flex-shrink-0">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#0E7C7B" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
                <polyline points="6 9 6 2 18 2 18 9"/><path d="M6 18H4a2 2 0 0 1-2-2v-5a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v5a2 2 0 0 1-2 2h-2"/><rect width="12" height="8" x="6" y="14"/>
              </svg>
            </div>
            <div className="flex-1 min-w-0">
              <div className="font-grotesk text-[15px] font-semibold text-ink">Print tickets</div>
              <div className="text-[13px] text-muted">Open your boarding passes to print or save as PDF</div>
            </div>
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-faint group-hover:text-muted transition-colors">
          ...
          <div className="flex items-center gap-4 bg-white rounded-card border border-card-border p-5">
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="text-[13px] text-muted truncate">Confirmation sent to {displayEmail}</div>
            </div>
          </div>
        ...
        <a href="/" className="block text-center text-[13px] text-muted mt-4 hover:text-ink underline transition-colors">
          Back to calendar
        </a>
      </div>
    </div>
