        ...
        <div className="bg-white rounded-card border border-card-border p-5 mb-8">
          <div className="flex justify-between items-center">
            <div>
              ...
              <div className="font-grotesk text-[28px] font-bold text-ink">{dollars(meta?.totalCents ?? totalCents)}</div>
            </div>
            <div className="text-[13px] text-muted">{(meta?.ticketCount ?? totalTickets)} ticket{(meta?.ticketCount ?? totalTickets) !== 1 ? "s" : ""}</div>
          </div>
        </div>
        ...
        {phase === "order" && (
          <form onSubmit={handleContactSubmit} className="mb-8">
            ...
            <div className="space-y-3 mb-4">
              <div>
                <label className="text-[11px] font-bold uppercase tracking-wide text-faint block mb-1.5">Email</label>
                <input
                  required
                  type="email"
                  autoComplete="email"
              ...
              <div>
                <label className="text-[11px] font-bold uppercase tracking-wide text-faint block mb-1.5">Mobile (for text updates)</label>
                <input
                  type="tel"
                  autoComplete="tel"
                  inputMode="numeric"
              ...
              {showName ? (
                <div>
                  <label className="text-[11px] font-bold uppercase tracking-wide text-faint block mb-1.5">Full name (optional)</label>
                  <input
                    type="text"
                    autoComplete="name"
                    value={name}
            ...
            >
              {submitting ? "Preparing payment…" : <>Continue to payment <ArrowRight /></>}
            </button>
