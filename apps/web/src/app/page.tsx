...
function HeroSection({
  ...
  return (
    <section
      ...
      style={{ background: "linear-gradient(150deg, #162D45 0%, #0D1B2A 100%)" }}
    >
      <div
      ...
      <div className="relative px-5 pt-10 pb-20 md:pt-14 md:pb-24 text-center max-w-xl mx-auto">
        <div
          className="inline-flex items-center justify-center w-14 h-14 rounded-[16px] mb-5"
        ...
        {fromPrice !== null && (
          <span
            className="inline-flex items-center gap-1.5 rounded-pill px-4 py-1.5 text-[13px] font-bold"
            style={{
      ...
      <div className="absolute bottom-0 left-0 right-0 leading-none">
        ...
        >
          <path
            d="M0 52L48 46C96 40 192 28 288 25.3C384 22.7 480 29.3 576 33.3C672 37.3 768 38.7 864 36C960 33.3 1056 26.7 1152 24C1248 21.3 1344 22.7 1392 23.3L1440 24V52H0Z"
            fill="#F4F6F6"
          />
        </svg>
      </div>
