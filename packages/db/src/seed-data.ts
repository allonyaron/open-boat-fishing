...
export const fleetData: VesselSeed[] = [
  {
    ...
    products: [
      {
        displayName: "4th of July Fireworks Cruise",
        category: "Fireworks",
        showRemaining: false,
        adult: 65,
        child: 65,
      ...
      {
        displayName: "Bay Fluke / Blues / Bass",
        category: "Fluke / Striper",
        showRemaining: true,
        adult: 61,
        child: 40,
      },
      {
        displayName: "Blackfishing",
        category: "Blackfish",
        showRemaining: true,
        adult: 65,
        child: 65,
      ...
      {
        displayName: "Opening Day Fluke Special",
        category: "Fluke",
        showRemaining: true,
        adult: 85,
        child: 85,
      ...
      {
        displayName: "Striped Bass, Bluefish, Weakfish",
        category: "Striped Bass",
        showRemaining: true,
        adult: 65,
        child: 65,
  ...
  },
  {
    ...
    products: [
      {
        displayName: "4th of July Fireworks",
        category: "Fireworks",
        showRemaining: false,
        adult: 65,
        child: 65,
      ...
      {
        displayName: "Bay Blues / Bass / Weakfish",
        category: "Striped Bass",
        showRemaining: true,
        adult: 65,
        child: 65,
      ...
      {
        displayName: "Fluke / Jigging Stripers & Blues",
        category: "Fluke / Striper",
        showRemaining: true,
        adult: 63,
        child: 63,
      ...
      {
        displayName: "Fluke / Sea Bass",
        category: "Sea Bass / Fluke",
        showRemaining: true,
        adult: 72,
        child: 72,
      },
      ...
      {
        displayName: "Full Day Wreck Fishing",
        category: "Sea Bass",
        showRemaining: true,
        adult: 119,
        child: 119,
      ...
      {
        displayName: "Night Bay Bluefish",
        category: "Striped Bass",
        showRemaining: true,
        adult: 62,
        child: 62,
      ...
      {
        displayName: "Night Ling Fishing",
        category: "Ling",
        showRemaining: true,
        adult: 79,
        child: 79,
      ...
      {
        displayName: "Striper / Pelagic Jigging",
        category: "Striper / Pelagics",
        showRemaining: true,
        adult: 69,
        child: 69,
      },
  ...
  },
  {
    ...
    products: [
      ...
      {
        displayName: "24 Hour Tilefish Special",
        category: "Tilefish",
        showRemaining: true,
        adult: 399,
        child: 399,
      ...
      {
        displayName: "Fluke / Sea Bass / Porgies",
        category: "Sea Bass / Fluke",
        showRemaining: false,
        adult: 59,
        child: 40,
      ...
      {
        displayName: "Night Bass / Blues / Weakfish",
        category: "Striped Bass",
        showRemaining: false,
        adult: 65,
        child: 40,
      ...
      {
        displayName: "Night Sea Bass / Porgies / Blues",
        category: "Sea Bass / Porgies",
        showRemaining: false,
      },
      {
      ...
      {
        displayName: "Pelagic Jigging Special",
        category: "Pelagics",
        showRemaining: true,
        adult: 65,
        child: 65,
      ...
      {
        displayName: "Princess Sea Bass Opener",
        category: "Sea Bass",
        showRemaining: false,
        adult: 75,
        child: 75,
  ...
  },
  {
    ...
    products: [
      {
        displayName: "34 Hour Canyon Tuna",
        category: "Bluefish",
        showRemaining: true,
        adult: 475,
        child: 475,
      ...
      {
        displayName: "Fluke / Jigging Bass / Blues / Weakfish",
        category: "Fluke / Striper",
        showRemaining: false,
      },
      { displayName: "Fluke", category: "Fluke", showRemaining: false, adult: 67, child: 47 },
      {
        displayName: "Full Day Ocean",
        category: "Fluke / Pelagics",
        showRemaining: false,
        adult: 95,
        child: 95,
      },
      {
        displayName: "Ling / Sea Bass / Porgy Marathon",
        category: "Ling",
        showRemaining: true,
        adult: 79,
        child: 79,
      ...
      {
        displayName: "Full Day Ocean Fluke",
        category: "Sea Bass / Fluke",
        showRemaining: false,
        adult: 105,
        child: 105,
      ...
      {
        displayName: "Full Day Wrecks",
        category: "Sea Bass / Ling",
        showRemaining: false,
        adult: 85,
        child: 85,
      },
      {
        displayName: "Sea Bass / Fluke",
        category: "Sea Bass / Fluke",
        showRemaining: false,
        adult: 62,
        child: 40,
      ...
      {
        displayName: "Trophy Striper Hunt",
        category: "Striped Bass",
        showRemaining: false,
        adult: 67,
        child: 67,
      ...
      {
        displayName: "Two Day Tilefish & Tuna",
        category: "Tilefish",
        showRemaining: true,
        adult: 700,
        child: 700,
